...
namespace MVC_Tuincentrum.Controllers
{
    ...
    public class LeverancierController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LevNr,Naam,Adres,PostNr,Woonplaats,Versie")] Leverancier leverancier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LevNr,Naam,Adres,PostNr,Woonplaats,Versie")] Leverancier leverancier)
        {
            if (ModelState.IsValid)
            {
